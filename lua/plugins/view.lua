return {
  ...
  },
  {
    ...
    opts = {
      -- TODO: buggy with scope.nvim
      file_association_policy = {
        { ".*.test.ts", 2 }, -- auto open test file in second tab
        { ".*.ts", 1 }, -- auto open ts file in 1st tab
        { ".*.sh", 1 }, -- auto open sh file in 1st tab
      },
    },
